...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb) {
    await Firebase.initializeApp(options: const FirebaseOptions(
      apiKey: 'AIzaSyDQKn2V5XnofShVVs-_Z2AbCRfy9UVtvmw',
      appId: '1:179045586262:android:ac0029b8c7d50b6dd2f2f7',
      messagingSenderId: '179045586262',
      projectId: 'badaati-stack',
    ));
    MetaSEO().config();
